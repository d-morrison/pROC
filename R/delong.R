...
ci_delong <- function(calcs, conf.level) {
  ...
  # CI is calculated using the normally distributed pivot given in DeLong's 1988 paper.
  # For unpaired tests, this uses a Gaussian approximation with pooled standard errors.
