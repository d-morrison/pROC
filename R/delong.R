...
ci_delong <- function(calcs, conf.level) {
  ...
  # CI is calculated using the normally distributed pivot given in DeLong's 1988 paper for paired tests.
  # For unpaired tests, this uses a t-distribution with Welch-Satterthwaite degrees of freedom.

  # Check if this is an unpaired test (has df) or paired test
  if (!is.null(calcs$df)) {
