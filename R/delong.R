...
# function to calculate the CI for unpaired test
ci_delong_unpaired <- function(calcs, conf.level) {
  # Input calcs is a list generated by delong.unpaired.calculations().
  # CI is calculated using a Gaussian approximation with pooled standard errors.
